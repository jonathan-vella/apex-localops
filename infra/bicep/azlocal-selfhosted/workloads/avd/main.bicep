...
//     --template-file infra/bicep/azlocal-selfhosted/workloads/avd/main.bicep \
//     --parameters infra/bicep/azlocal-selfhosted/workloads/avd/main.bicepparam
//
...
param hostPoolName string = 'apexlocal-hp01'

@description('Desktop application group name.')
param appGroupName string = 'apexlocal-dag01'

@description('Workspace name.')
param workspaceName string = 'apexlocal-ws01'
