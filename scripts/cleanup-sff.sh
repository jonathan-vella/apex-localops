#!/usr/bin/env bash
#
# cleanup-sff.sh - Tear down the Azure Local SFF deployment and stop all billing.
#
...
#   ./cleanup-sff.sh --resource-group <n>  # default: rg-sff-host-swc01
#   ./cleanup-sff.sh --help
#
...
echo
echo "Note: this removes the host VM, the nested SFF test VM inside it, the staging"
echo "      storage account, and the Key Vault (incl. the stored ownership voucher)."
echo "      Subscription-level provider/feature registrations are left intact."
echo
